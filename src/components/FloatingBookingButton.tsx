  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <span
            className="relative flex items-center gap-3 bg-luxury-gold text-black px-5 py-4 md:px-7 md:py-5 rounded-full shadow-[0_6px_24px_rgba(200,168,118,0.35)] hover:shadow-[0_10px_32px_rgba(200,168,118,0.55)] transition-all duration-500 group-hover:scale-105"
          >
